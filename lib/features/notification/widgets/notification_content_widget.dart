...
import 'package:godelivery_user/features/notification/widgets/notification_bottom_sheet.dart';
import 'package:godelivery_user/features/notification/widgets/notification_dialog_widget.dart';
...
/// Reusable notification list content widget
/// Can be used in both full screen routes and bottom sheets
class NotificationContentWidget extends StatefulWidget {
  ...
  @override
  State<NotificationContentWidget> createState() => _NotificationContentWidgetState();
}
