...
class PortionWidget extends StatelessWidget {
  ...
  const PortionWidget({super.key, this.icon, this.iconData, required this.title, required this.route, this.hideDivider = false, this.suffix, this.onTap});
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(children: [
          Row(children: [
            iconData != null
              ? Icon(iconData, size: 16, color: Theme.of(context).textTheme.bodyMedium!.color)
