Perfect, this is exactly the kind of thing a Claude “flow-editing” agent will understand.
Here’s a clean **blueprint of the Cart → Order Details → Checkout flow**, no code, just logic and behavior.
